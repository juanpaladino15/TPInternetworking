...
//     // Agregar el usuario y la contraseña al mensaje Logon
//     if (message.getHeader().getField(FIX::FIELD::MsgType) == FIX::MsgType_Logon)
//     {
//       message.setField(FIX::FIELD::Username, "jpaladino7967");
//       message.setField(FIX::FIELD::Password, "yqlkiH6&");
//     }
//   }
...
void Application::toApp(FIX::Message& message, const FIX::SessionID& sessionID) EXCEPT(FIX::DoNotSend)
{
  try
  {
    ...
    // Ajustar los campos para que coincidan con el formato deseado del logon
    if (message.getHeader().getField(FIX::FIELD::MsgType) == FIX::MsgType_Logon)
    {
      message.setField(8, "FIXT.1.1");
      message.setField(9, "133");
      message.setField(35, "A");
      message.setField(34, "1");
      message.setField(49, "jpaladino7967");
      message.setField(52, "20230511-12:51:47.850");
      message.setField(56, "ROFX");
      message.setField(58, "Mensajero FIX");
      message.setField(98, "0");
      message.setField(108, "30");
      message.setField(141, "Y");
      message.setField(553, "jpaladino7967");
      message.setField(554, "yqlkiH6&");
      message.setField(1137, "7");
      message.setField(10, "032");
    }
  }
  catch (FIX::FieldNotFound&) {}
